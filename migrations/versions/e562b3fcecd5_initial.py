...
Revision ID: e562b3fcecd5
Revises: 
Create Date: 2023-06-29 12:12:28.902501
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'approved', 'reject', name='state'), server_default='pending', nullable=False),
